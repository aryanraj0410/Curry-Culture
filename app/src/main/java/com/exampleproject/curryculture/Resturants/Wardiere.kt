        ...
        Column {
                ...
                ))
            {
                Column(modifier = Modifier.fillMaxSize())
                {
                    ...
                    {
                        Image(painter = painterResource(id = R.drawable.rest_4), contentDescription =null,
                            modifier = Modifier
                                .size(180.dp)
                                .padding(20.dp))
                        Column {
                            Text(
                                text = "Wardiere", Modifier.padding(top = 40.dp),
                                fontSize = 40.sp,
                                fontWeight = FontWeight.ExtraBold,
                                fontStyle = FontStyle.Italic,
                                color = orange
                            )
                            Text(text = "⭐ : 4.9/5",fontSize = 18.sp)
            ...
            Row(modifier = Modifier.horizontalScroll(rememberScrollState()))
            {
                    ...
                    ))
                {
                    ...
                    {
                        Image(painter = painterResource(id = R.drawable.egg_curry),
                            contentDescription =null,)
                        Text(text = "Egg Curry", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹145",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                    ...
                    ))
                {
                    Column(verticalArrangement = Arrangement.Center,
                        ...
                        modifier = Modifier.padding(start = 35.dp))
                    {
                        Image(painter = painterResource(id = R.drawable.egg_roll),
                            contentDescription =null,)
                        Text(text = "Egg Roll", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹45",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                        ExploreButton(text = "ADD TO CART", modifier = Modifier.width(200.dp))
                    ...
                    ))
                {
                    Column(verticalArrangement = Arrangement.Center,
                        ...
                        modifier = Modifier.padding(start = 35.dp))
                    {
                        Image(painter = painterResource(id = R.drawable.aalu_paratha),
                            contentDescription =null,)
                        Text(text = "Aalu Paratha", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹40",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                        ExploreButton(text = "ADD TO CART", modifier = Modifier.width(200.dp))

        ...
        Column {
                ...
                ))
            {
                Column(modifier = Modifier.fillMaxSize())
                {
                    ...
                    {
                        Image(painter = painterResource(id = R.drawable.rest_1), contentDescription =null,
                            modifier = Modifier
                                .size(180.dp)
                                .padding(20.dp))
                        Column {
                            Text(
                                text = "RIMBERIO", Modifier.padding(top = 40.dp),
                                fontSize = 40.sp,
                                fontWeight = FontWeight.ExtraBold,
                                fontStyle = FontStyle.Italic,
                                color = orange
                            )
                            Text(text = "⭐ : 4.3/5",fontSize = 18.sp)
            ...
            Row(modifier = Modifier.horizontalScroll(rememberScrollState()))
            {
                ...
                ))
                {
                    ...
                    {
                        Image(painter = painterResource(id = R.drawable.chicken_biryani_removebg_preview),
                            contentDescription =null,)
                        Text(text = "Chicken Biryani", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹120",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                    ...
                    ))
                {
                    Column(verticalArrangement = Arrangement.Center,
                        ...
                        modifier = Modifier.padding(start = 35.dp))
                    {
                        Image(painter = painterResource(id = R.drawable.paneer_masala),
                            contentDescription =null,)
                        Text(text = "Panner Masala", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹180",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                        ExploreButton(text = "ADD TO CART", modifier = Modifier.width(200.dp))
                    ...
                    ))
                {
                    Column(verticalArrangement = Arrangement.Center,
                        ...
                        modifier = Modifier.padding(start = 35.dp))
                    {
                        Image(painter = painterResource(id = R.drawable.garlic_naan),
                            contentDescription =null,)
                        Text(text = "Garlic Naan", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹35",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                        ExploreButton(text = "ADD TO CART", modifier = Modifier.width(200.dp))

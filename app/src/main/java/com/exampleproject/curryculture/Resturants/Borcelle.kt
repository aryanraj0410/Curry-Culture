        ...
        Column {
                ...
                ))
            {
                Column(modifier = Modifier.fillMaxSize())
                {
                    ...
                    {
                        Image(painter = painterResource(id = R.drawable.rest_2), contentDescription =null,
                            modifier = Modifier
                                .size(180.dp)
                                .padding(20.dp))
                        Column {
                            Text(
                                text = "BORCELLE Catering", Modifier.padding(top = 40.dp),
                                fontSize = 40.sp,
                                fontWeight = FontWeight.ExtraBold,
                                fontStyle = FontStyle.Italic,
                                color = orange
                            )
                            Text(text = "⭐ : 4.4/5",fontSize = 18.sp)
            ...
            Row(modifier = Modifier.horizontalScroll(rememberScrollState()))
            {
                    ...
                    ))
                {
                    ...
                    {
                        Image(painter = painterResource(id = R.drawable.tawa_roti),
                            contentDescription =null,)
                        Text(text = "Tawa Roti", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹20",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                    ...
                    ))
                {
                    Column(verticalArrangement = Arrangement.Center,
                        ...
                        modifier = Modifier.padding(start = 35.dp))
                    {
                        Image(painter = painterResource(id = R.drawable.dosa),
                            contentDescription =null,)
                        Text(text = "Dosa", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)

                        Spacer(modifier = Modifier.height(20.dp))
                        Text(text = "₹75",fontWeight = FontWeight.Bold, fontSize = 20.sp,color = orange)
                        Spacer(modifier = Modifier.height(20.dp))
                        ExploreButton(text = "ADD TO CART", modifier = Modifier.width(200.dp))
                    ...
                    ))
                {
                    Column(verticalArrangement = Arrangement.Center,
                        ...
                        modifier = Modifier.padding(start = 35.dp))
                    {
                        Image(painter = painterResource(id = R.drawable.rajma_chawal),
                            contentDescription =null,)
                        Text(text = "Rajma Chawal", fontWeight = FontWeight.Bold, fontSize = 25.sp,color = Color.Black)
